...
{
    [Command(PackageIds.ViewModeDeprecatedCommand)]
    internal sealed class ViewModeDeprecatedCommand : BaseCommand<ViewModeDeprecatedCommand>
    {
        protected override void BeforeQueryStatus(EventArgs e)
        {
            ...
            Command.Checked = vm?.ViewMode == PackageViewMode.Deprecated;
        }
